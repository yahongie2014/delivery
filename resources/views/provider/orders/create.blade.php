                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group {{ $errors->has('client_name') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" required  name="client_name" id="exampleInputName" placeholder="{{__('general.Full Name Ex')}}" @if(old('client_name')) value="{{old('client_name')}}" @endif>
                                                ...
                                                <div class="form-group {{ $errors->has('client_phone') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" required class="form-control allownumericwithoutdecimal" id="exampleInputEmail" name="client_phone" maxlength="15" placeholder="{{__('general.Phone Ex')}}" @if(old('client_phone')) value="{{old('client_phone')}}" @endif>
                                                        <div class="input-group-addon">
                                                ...
                                                <div class="form-group {{ $errors->has('client_address') ? ' has-error' : '' }}">
                                                    ...
                                                    <textarea class="form-control required" cols="20" id="exampleInputAddress" name="client_address" >{{e(old('client_address'))}}</textarea>
...
<script>
    ...
    function initialize() {
        var mapOptions = {
            zoom: 5,
            center: new google.maps.LatLng(26.745610382199025,43.9453125),
