    ...
    function myMap() {
        ...
        if(orderLat && orderLong && navigator.geolocation){
            ...
            navigator.geolocation.getCurrentPosition(function (position) {
                html = "<span style='margin-right: 20px;font-weight: bold'><b>{{$order->client_name}}</b><br><b>{{$order->client_phone}}</b><br><u><a style='color: green;' href='https://www.google.com.eg/maps/dir/"+ position.coords.latitude +"," + position.coords.longitude + "/" + orderLat + "," + orderLong + "'>Open Direction</a></u></span>";
