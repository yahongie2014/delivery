...
<div class="wrapper pa-0">
    <header class="sp-header">
        ...
        <div class="form-group mb-0 pull-right">
            ...
            <a class="inline-block btn btn-success btn-rounded btn-outline nonecase-font" href="{{ route('logout') }}" onclick="event.preventDefault();
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="mb-30">
                                    ...
                                    <span class="text-center nonecase-font mb-20 block error-comment">{{ $missingPrivilege }}</span>
                                    <p class="text-center">{{__('general.contact support')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
